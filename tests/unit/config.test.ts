...
test("config validation enforces documented scalar boundaries and key grammar", async () => {
  ...
  const cases = [
    ...
    ["core.statusDetail", "quiet", true],
    ["core.statusDetail", "summary", true],
    ["core.statusDetail", "diagnostic", true],
    ["core.statusDetail", "verbose", false],
    ["core.agentInjectionTransport", "systemPrompt", true],
    ["core.agentInjectionTransport", "providerPayload", true],
    ["core.agentInjectionTransport", "auto", true],
    ["core.agentInjectionTransport", "off", true],
    ["core.agentInjectionTransport", "customMessage", false],
    ["core.widgetMaxLines", 3, false],
